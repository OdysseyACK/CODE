...
export default function HomePage() {
  ...
  return (
    <div className="homepage">
      ...
      <div class="custom-shape-divider-bottom-1683291772">
        <svg
          data-name="Layer 1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1200 120"
          ...
          <MDBCol sm={12} md={6} lg={3} className="mb-5">
            <div className="d-flex justify-content-center">
              <div class="party-book">
                <div class="party-cover color-change-5x">
                  <p>Parties</p>
                </div>
              </div>
            </div>
      ...
      <div class="custom-shape-divider-top-1683298748">
        <svg
          data-name="Layer 1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1200 120"
      ...
      <div class="custom-shape-divider-bottom-1683299503">
        <svg
          data-name="Layer 1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1200 120"
